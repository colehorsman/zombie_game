...
- [ ] 1. Create LevelEntryMenuController
  - [ ] 1.1 Create `src/level_entry_menu_controller.py` with LevelEntryAction enum and LevelEntryMenuController class
  ...
  - [ ] 1.2 Write property tests for LevelEntryMenuController
    - **Property 1: Default Selection Respects Configuration**
    - **Validates: Requirements 1.1, 5.3**

  - [ ] 1.3 Write property test for navigation
    - **Property 2: Navigation Wraps Within Bounds**
    - **Validates: Requirements 2.1, 2.4**

  - [ ] 1.4 Write property test for selection
    - **Property 3: Selection Returns Correct Action**
    - **Validates: Requirements 2.2**

  - [ ] 1.5 Write property test for cancel
    - **Property 4: Cancel Always Returns Cancel Action**
    - **Validates: Requirements 2.3**

  - [ ] 1.6 Write property tests for message building
...
- [ ] 2. Integrate with GameEngine
  - [ ] 2.1 Add configuration reading in GameEngine.__init__
  ...
  - [ ] 2.2 Modify door collision handling for Sandbox level
  ...
  - [ ] 2.3 Add input handling for level entry menu
...
- [ ] 3. Update Renderer
  - [ ] 3.1 Add level entry menu rendering
