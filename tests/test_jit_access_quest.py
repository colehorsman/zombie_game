...
class TestCreateJitQuestEntities:
    ...
    def test_create_entities_multiple_permission_sets(self, sample_permission_set, protected_permission_set):
...
class TestJitQuestIntegration:
    ...
    def test_quest_workflow_protect_all_roles(self, sample_permission_set, protected_permission_set):
        ...
        permission_sets = [sample_permission_set, protected_permission_set, unprotected_ps]
