...
from main import load_configuration, calculate_scaled_dimensions, initialize_pygame
...
class TestInitializePygame:
    ...
    def test_initialize_pygame_fullscreen_mode(
        ...
        mock_set_mode.assert_called_once_with((1920, 1080), pygame.FULLSCREEN)
    ...
    def test_initialize_pygame_windowed_mode(
        ...
        mock_set_mode.assert_called_once_with((1280, 720), pygame.RESIZABLE)
