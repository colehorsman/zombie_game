...
class TestQuestTriggerWithEnterKey:
    ...
    def test_enter_key_dismisses_quest_dialog_and_spawns_hacker(
    ...
    def test_enter_key_sets_hacker_target_to_service_position(
        self, game_engine_with_quest
    ):
    ...
    def test_enter_key_does_nothing_when_quest_not_triggered(
        self, game_engine_with_quest
    ):
...
class TestQuestTriggerWithSpaceKey:
    ...
    def test_space_key_dismisses_quest_dialog_and_spawns_hacker(
        self, game_engine_with_quest
    ):
    ...
    def test_space_key_does_nothing_when_no_quest_manager(
...
class TestQuestTriggerPauseMessageDismissal:
    ...
    def test_enter_key_dismisses_pause_message_when_no_quest(
        self, mock_pygame, mock_api_client
    ):
    ...
    def test_space_key_dismisses_pause_message_when_no_quest(
        self, mock_pygame, mock_api_client
    ):
    ...
    def test_quest_trigger_takes_priority_over_pause_dismissal(
        self, game_engine_with_quest
    ):
...
class TestQuestTriggerEdgeCases:
    ...
    def test_enter_and_space_both_work_for_same_quest(
        self, mock_pygame, mock_api_client
    ):
        ...
        quest1 = create_bedrock_protection_quest(
            "test1", 1, Vector2(200, 400), Vector2(5000, 400)
        )
        ...
        quest2 = create_bedrock_protection_quest(
            "test2", 1, Vector2(200, 400), Vector2(5000, 400)
        )
