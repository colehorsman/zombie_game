...
class TestPauseMenuArcadeOption:
    ...
    def test_arcade_option_only_in_sandbox_account(self, mock_pygame, mock_api_client, mock_level_manager):
...
class TestPauseMenuIntegration:
    ...
    def test_pause_menu_options_count_in_different_contexts(self, mock_pygame, mock_api_client, mock_level_manager):
...
class TestPauseMenuEdgeCases:
    ...
    def test_arcade_option_not_duplicated(self, game_engine_in_sandbox):
        ...
        for _ in range(3):
            ...
            arcade_count = sum(1 for opt in engine.pause_menu_options if opt == "🎮 Arcade Mode")
