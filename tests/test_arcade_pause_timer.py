...
class TestArcadeTimerPauseBehavior:
    ...
    def test_arcade_timer_updates_during_playing_status(self, game_engine_with_arcade):
        ...
        assert engine.arcade_manager.time_remaining == pytest.approx(
            initial_time - 1.0, abs=0.01
        )
    ...
    def test_arcade_state_synced_during_pause(self, game_engine_with_arcade):
        ...
        assert (
            engine.game_state.arcade_mode.time_remaining
            == engine.arcade_manager.time_remaining
        )
    ...
    def test_arcade_timer_only_updates_in_playing_not_lobby(
        self, game_engine_with_arcade
    ):
    ...
    def test_arcade_timer_only_updates_in_playing_not_boss_battle(
        self, game_engine_with_arcade
    ):
...
class TestArcadeTimerPauseEdgeCases:
    ...
    def test_multiple_pause_resume_cycles(self, game_engine_with_arcade):
        ...
        assert engine.arcade_manager.time_remaining == pytest.approx(
            initial_time - 2.0, abs=0.01
        )

    def test_arcade_state_synced_when_session_ends_during_pause(
        self, game_engine_with_arcade
    ):
