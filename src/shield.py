...
def create_small_shield_sprite() -> pygame.Surface:
    ...
    pygame.draw.line(shield, PURPLE_HIGHLIGHT, 
                    (shield_width // 2, 4), 
                    (shield_width // 2, shield_height - 4), 2)
...
def render_shield(surface: pygame.Surface, entity, camera_offset: tuple = (0, 0), pulse_time: float = 0.0):
    """
